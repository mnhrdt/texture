...
bin/colormultiple $lidar $exp_dir/data/cropped/cropped_img_$IDX.tif data/rpc/img_$IDX.rpc $exp_dir/data/matches/matches_lidar_img_$IDX.tif $exp_dir/mesh/pil_multi_$IDX.ply $exp_dir/mesh/atlas_multi_$IDX -ox $ox -oy $oy
#
qeasy 100 1100 $exp_dir/mesh/atlas_multi_$IDX.tif $exp_dir/mesh/atlas_multi_$IDX.png
##
