...
\begin{itemize}
	...
	\item A bad mesh with a good texture will look god.  Thus, we can
		start working right away with watever mesh and see \emph{the
...
\begin{itemize}
	...
	\item If you produce a new texture, you have to enforce the
		...
		comatibility condition is not clear how to you need to solve
